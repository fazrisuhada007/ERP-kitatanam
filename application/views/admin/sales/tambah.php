	...
	<form method="POST" action="<?php base_url('admin/sales/tambah')?>" class="m-form m-form--fit m-form--label-align-right">
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group">
				...
				<input type="text" class="form-control m-input m-input--square" id="no_ktp" name="no_ktp" value="<?php echo set_value('no_ktp')?>" placeholder="Inputkan nomor induk kependudukan">
			</div>

			<div class="form-group m-form__group">
				<label for="nama_sales">Nama Sales</label>
				<input type="text" class="form-control m-input m-input--square" id="nama_sales" name="nama_sales" value="<?php echo set_value('nama_sales')?>" placeholder="Inputkan nama sales">
			</div>

			<div class="form-group m-form__group">
				<label for="telp">Nomor Telepon</label>
				<input type="text" class="form-control m-input m-input--square" id="telp" name="telp" value="<?php echo set_value('telp')?>" placeholder="Inputkan nomor telepon">
			</div>

			<div class="form-group m-form__group">
				<label for="email">Alamat Email</label>
				<input type="text" class="form-control m-input m-input--square" id="email" name="email" value="<?php echo set_value('email')?>" placeholder="Inputkan alamat email">
			</div>
