	...
	<form method="POST" action="<?php base_url('admin/sales/edit'.$sales->id_sales)?>" class="m-form m-form--fit m-form--label-align-right">
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group">
				...
				<input type="text" class="form-control m-input m-input--square" id="nama_kelompok" name="nama_kelompok" value="<?php echo $kelompok_tani->nama_kelompok ?>" autocomplete="off"/>
			</div>
